...
The goal of Version 1 is to build a functional platform that assists researchers in performing literature reviews efficiently using a multi-agent AI workflow.
